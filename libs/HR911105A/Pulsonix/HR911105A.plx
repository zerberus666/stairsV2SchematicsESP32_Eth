...
(library Library_1
	...
	(patternDef "HR911105A" (originalName "HR911105A")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -4.450, 6.350) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -12.465 -4.3) (pt 3.575 -4.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.575 -4.3) (pt 3.575 17) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.575 17) (pt -12.465 17) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -12.465 17) (pt -12.465 -4.3) (width 0.025))
		)
	...
	(compDef "HR911105A" (originalName "HR911105A") (compHeader (numPins 14) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://datasheet.lcsc.com/szlcsc/Zhongshan-HanRun-Elec-HR911105A_C12074.pdf")
		(attr "<Component Height>" "13.75")
		(attr "<STEP Filename>" "HR911105A.stp")
		(attr "<STEP Offsets>" "X=3.49;Y=17.32;Z=13.53")
